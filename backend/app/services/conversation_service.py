...
async def get_or_create_cached_greeting(language: str) -> bytes:
    ...
    greetings = {
        "en": "Hello, I'm Adhikar, your legal adviser. What can I help you with today?",
        "hi": "नमस्ते, मैं अधिकार हूँ। आज आपकी क्या सहायता कर सकता हूँ?",
        "ta": "வணக்கம், நான் அதிகார். இன்று நான் உங்களுக்கு எவ்வாறு உதவ முடியும்?",
        "te": "నమస్కారం, నేను అధికార్. ఈరోజు మీకు ఎలా సహాయపడగలను?",
        "bn": "নমস্কার, আমি অধিকার। আজ আপনাকে কীভাবে সাহায্য করতে পারি?",
        "mr": "नमस्कार, मी अधिकार आहे. आज मी तुम्हाला कशी मदत करू शकतो?",
        "gu": "નમસ્તે, હું અધિકાર છું. આજે હું તમને કેવી રીતે મદદ કરી શકું?",
        "kn": "ನಮಸ್ಕಾರ, ನಾನು ಅಧಿಕಾರ. ಇಂದು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಲಿ?",
        "ml": "നമസ്കാരം, ഞാൻ അധികാർ ആണ്. ഇന്ന് ഞാൻ നിങ്ങളെ എങ്ങനെ സഹായിക്കണം?",
        "pa": "ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ, ਮੈਂ ਅਧਿਕਾਰ ਹਾਂ। ਅੱਜ ਮੈਂ ਤੁਹਾਡੀ ਕੀ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ?"
    }
