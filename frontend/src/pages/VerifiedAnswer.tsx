  ...
  return (
    <AppShell>
      <div className="max-w-3xl">
        <h1 className="text-2xl md:text-3xl font-serif font-bold text-nyaya-text-dark mb-2">Verified Answer</h1>
        ...
        <div className="bg-white rounded-2xl border border-black/8 p-8 shadow-sm text-center">
          ...
          <h3 className="font-serif font-semibold text-lg text-nyaya-text-dark mb-2">Verified RAG Interface</h3>
